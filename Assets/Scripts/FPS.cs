...
{
    float _updateInterval = 1f;// ”станавливаем временной интервал дл€ обновлени€ частоты кадров до 1 секунды  
    float _accum = .0f;// —уммарное врем€  
    int _frames = 0;// —колько кадров было запущено за врем€ _updateInterval  
    float _timeLeft;
    string fpsFormat;
